...
public class MapperParser extends MapperAnnotationBuilder {
    ...
    public MapperParser(SwiftConfiguration configuration, Class<?> type) {
    ...
    protected String parseResultMap(Method method) {
    ...
    protected String generateResultMapName(Method method) {
        Results results = method.getAnnotation(Results.class);
    ...
    protected void applyResultMap(String resultMapId, Class<?> returnType, Arg[] args, Result[] results, TypeDiscriminator discriminator) {
    ...
    protected void createDiscriminatorResultMaps(String resultMapId, Class<?> resultType, TypeDiscriminator discriminator) {
    ...
    protected void parseStatement(Method method) {
    ...
    protected SqlSource getSqlSourceFromAnnotations(Method method, Class<?> parameterType, LanguageDriver languageDriver) {
        try {
    ...
    protected SqlCommandType getSqlCommandType(Method method) {
    ...
    protected Class<? extends Annotation> getSqlAnnotationType(Method method) {
        return chooseAnnotationType(method, sqlAnnotationTypes);
    }

    protected Class<? extends Annotation> getSqlProviderAnnotationType(Method method) {
        return chooseAnnotationType(method, sqlProviderAnnotationTypes);
    }

    protected Class<? extends Annotation> chooseAnnotationType(Method method, Set<Class<? extends Annotation>> types) {
    ...
    protected Result[] resultsIf(Results results) {
        return results == null ? new Result[0] : results.value();
    }

    protected Arg[] argsIf(ConstructorArgs args) {
        return args == null ? new Arg[0] : args.value();
    }

    protected KeyGenerator handleSelectKeyAnnotation(SelectKey selectKeyAnnotation, String baseStatementId, Class<?> parameterTypeClass, LanguageDriver languageDriver) {
